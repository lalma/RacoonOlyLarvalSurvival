...
setwd("C:/Users/Lindsay/Dropbox/Raccoon/larvae/oyster/larvae survival stats/GitHub/RacoonOlyLarvalSurvival/LikelihoodLarvaeJar")
...
##84 rows long
library(readxl)
d_fake <- read_excel("real data.xlsx")
View(d_fake)
